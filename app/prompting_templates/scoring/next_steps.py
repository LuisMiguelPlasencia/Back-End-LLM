def next_steps(transcript):
    ...
    Para considerar que el vendedor ha cumplido su objetivo, NO basta con una despedida educada o un vago "ya vamos hablando". 
    Tuvo que haber propuesto una acción específica: agendar fecha/hora, enviar un presupuesto, programar una demo o definir quién contactará a quién y cuándo. Si no hay compromiso claro, no lo des por conseguido.
